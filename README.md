...
[Write Theory](#Write-Theory) - Write ST calls the easy way in a Form with an Entry for each parameter. It generates the code and links to Help.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2OTIxMzcxOSwtMzk1MjkwMDUzLC0yMT
