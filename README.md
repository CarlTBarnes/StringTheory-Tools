...
[Write Theory](#Write-Theory) - Write ST calls the easy way in a Form with an Entry for each parameter.  which then generates the code and links to Help.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjg4ODQwNzk2LC0zOTUyOTAwNTMsLTIxMT
